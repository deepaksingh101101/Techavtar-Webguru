...
import logo from '../../assets/images/techavtar-webguru-high-resolution-logo-transparent-removebg-preview.png'
import './Footer.css'
          ...
          <div className="row gy-4 gy-lg-0 justify-content-xl-between">
            <div className="col-12 col-md-4 col-lg-3 col-xl-2">
              <div className="widget">
                <a href="#!">
                  <img src={logo} alt="BootstrapBrain Logo" width="175" height="67"/>
                </a>
              </div>
            </div>
            <div className="col-12 col-md-4 col-lg-3 col-xl-2">
              <div className="widget">
                ...
                <address className="mb-4">A30/31, Spice Garden Layout,  Marathahalli, Bengaluru, Karnataka 560037</address>
                <p className="mb-1">
                  <a className="link-secondary text-decoration-none" href="tel:+15057922430">+91 9234129799</a>
                </p>
                <p className="mb-0">
                  <a className="link-secondary text-decoration-none" href="mailto:support@techavtar.com">dsupport@techavtar.com</a>
                </p>
              </div>
            </div>
            <div className="col-12 col-md-4 col-lg-3 col-xl-2">
            ...
            <div className="col-12 col-lg-3 col-xl-4">
              <div className="widget">
                ...
                <p className="mb-4" style={{color:"black"}}>Subscribe to our newsletter to get our news & discounts delivered to you.</p>
                <form action="#!">
